...
%
% Comment: using back-to-the-prior forgetting. This version uses a separate
% pruning function that can be triggered from outside, for demonstration
% purposes.
%
