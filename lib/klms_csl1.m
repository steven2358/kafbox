...
% criterion and L1-norm regularization
%
...
classdef klms_csl1 < handle
    ...
    methods
        ...
        function kaf = klms_csl1(parameters) % constructor
        ...
        function train(kaf,x,y) % train the algorithm
            ...
            kaf.alpha = kaf.prox(kaf.lambda,kaf.alpha);
    ...
    methods (Static = true)
        ...
        function alphap = prox(lambda,alpha)
            alphap = sign(alpha).*max(abs(alpha) - lambda, 0);
        end
